...
<div class="tab3">
    ...
    <div class="row">
        ...
        <ul class="tab_3_icns">
            ...
            <li><input name="sfsi_actvite_theme" <?php echo ($option3['sfsi_actvite_theme'] == 'flat') ?  'checked="true"' : ''; ?> type="radio" value="flat" class="styled" /><label><?php _e('Flat','ultimate-social-media-icons') ?></label>
                <div class="icns_tab_3"><span class="row_2_1 rss_section"></span><span class="row_2_2 email_section"></span><span class="row_2_3 facebook_section"></span><span class="row_2_5 twitter_section"></span><span class="row_2_7 youtube_section"></span><span class="row_2_8 pinterest_section"></span><span class="row_2_9 linkedin_section"></span><span class="row_2_10 instagram_section"></span><span class="row_2_14 telegram_section"></span><span class="row_2_15 vk_section"></span><span class="row_2_16 ok_section"></span><span class="row_2_19 whatsapp_section"></span><span class="row_2_17 weibo_section"></span><span class="row_2_18 wechat_section"></span>
                ...
                <li class="sfsi_custom_icons_q4">
                    <div style="float: left;">
                        <a class="pop-up" data-id="sfsi_quickpay-overlay" onclick="sfsi_open_quick_checkout(event)" target="_blank" style="display: flex;">
                            ...
                            <label style="line-height:20px !important;margin-top:15px;opacity:0.5"><?php _e('Custom Icons -','ultimate-social-media-icons') ?></label>
                        </a>
                    </div>
                    <div>
